    ...
    <div>
      ...
      {tab === "profile" && (
        <div>
          ...
          />
          <br />
          <button onClick={() => setTab("interest")}>Next</button>
        </div>
      )}
        ...
        <div>
          ...
          <label>
            <input
              ...
              onChange={() =>
                setHobbies({ ...hobbies, coding: !hobbies.coding })
              }
            />{" "}
            Coding
          </label>
          ...
          <br />
          <button onClick={() => setTab("settings")}>Next</button>
        </div>
      )}
        ...
        <div>
          ...
          <label>
            <input
              type="radio"
              value="off"
              checked={notification === "off"}
              onChange={() => setNotification("off")}
            />{" "}
            Off
          </label>
          <br />
